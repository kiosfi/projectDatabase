...
describe("Project list page", function () {
    ...
    it("should list registered projects in correct order", function () {
        ...
        expect(rep.get(0).all(by.tagName("td")).get(0).getText()).toEqual("70009");
        expect(rep.get(1).all(by.tagName("td")).get(0).getText()).toEqual("70001");
        expect(rep.get(2).all(by.tagName("td")).get(0).getText()).toEqual("70011");
        expect(rep.get(3).all(by.tagName("td")).get(0).getText()).toEqual("70012");
        expect(rep.get(4).all(by.tagName("td")).get(0).getText()).toEqual("70002");
        expect(rep.get(5).all(by.tagName("td")).get(0).getText()).toEqual("70006");
        expect(rep.get(6).all(by.tagName("td")).get(0).getText()).toEqual("70007");
        expect(rep.get(7).all(by.tagName("td")).get(0).getText()).toEqual("70008");
        expect(rep.get(8).all(by.tagName("td")).get(0).getText()).toEqual("70015");
        expect(rep.get(9).all(by.tagName("td")).get(0).getText()).toEqual("70014");
        element(by.id("byTitle")).click();
        rep = element.all(by.repeater("project in projects"));
        expect(rep.count()).toEqual(10);
        expect(rep.get(0).all(by.tagName("td")).get(0).getText()).toEqual("70013");
        expect(rep.get(1).all(by.tagName("td")).get(0).getText()).toEqual("70010");
        expect(rep.get(2).all(by.tagName("td")).get(0).getText()).toEqual("70004");
        expect(rep.get(3).all(by.tagName("td")).get(0).getText()).toEqual("70003");
        expect(rep.get(4).all(by.tagName("td")).get(0).getText()).toEqual("70014");
        expect(rep.get(5).all(by.tagName("td")).get(0).getText()).toEqual("70015");
        expect(rep.get(6).all(by.tagName("td")).get(0).getText()).toEqual("70008");
        expect(rep.get(7).all(by.tagName("td")).get(0).getText()).toEqual("70007");
        expect(rep.get(8).all(by.tagName("td")).get(0).getText()).toEqual("70006");
        expect(rep.get(9).all(by.tagName("td")).get(0).getText()).toEqual("70002");
    });
