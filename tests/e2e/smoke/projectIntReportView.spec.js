...
describe("Project intermediary report view page", function () {
    ...
    xit("should stay int report view page if logged in ", function () {
        helpers.login();
    ...
    xit("should show details of report if logged in", function () {
        helpers.login();
...
//        expect(header.getText()).toContain("1. väliraportti");
    ...
    it("should redirect to empty home page if not logged in ", function () {
        ...
        expect(text.getText()).toContain("Hanketietojärjestelmä");
    })
});
