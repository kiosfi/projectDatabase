...
\begin{document}
	...
	\begin{tabularx}{\textwidth}{| l X l X |}
		...
		\textbf{<titles.approved.themes-disambiguation>} & \multicolumn{3}{>{\hsize=\dimexpr3\hsize+4\tabcolsep+2\arrayrulewidth\relax}X|}{<approved.themes-disambiguation>} \\ \hline
	\end{tabularx}
